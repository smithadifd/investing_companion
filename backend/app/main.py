...
# Include routers
from app.api.v1.endpoints import account, ai, alert, auth, cash, dashboard, equity, event, export, lesson, market, news, ratio, schwab, settings, trade, trigger, watchlist  # noqa: E402
