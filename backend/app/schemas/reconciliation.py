...
class ReconciliationPosition(BaseModel):
    ...
    schwab_quantity: Optional[Decimal] = None
    ic_quantity: Optional[Decimal] = None
    # NEVER null: an absent side is treated as 0 (§2) -
    # (schwab_quantity ?? 0) - (ic_quantity ?? 0).
    quantity_delta: Decimal

    schwab_basis: Optional[Decimal] = None
    ...
    basis_delta: Optional[Decimal] = None
...
class ReconciliationResponse(BaseModel):
    ...
    newer_failed_import_at: Optional[datetime] = None
