...
ssh -p 12221 fivefootfive@192.168.50.88
```
...
CORS_ORIGINS=http://192.168.50.88:3000,http://localhost:3000

# Frontend API URL (what the browser uses)
NEXT_PUBLIC_API_URL=http://192.168.50.88:8000/api/v1
...
|---------|-------------------------|---------------------|
| Frontend | http://localhost:3000 | http://192.168.50.88:3000 |
| API | http://localhost:8000 | http://192.168.50.88:8000 |
| API Docs | http://localhost:8000/docs | http://192.168.50.88:8000/docs |
...
3. **The application is only accessible on the local network** (192.168.50.x) unless you configure port forwarding
