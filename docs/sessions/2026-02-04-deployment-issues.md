...
1. **CORS Error** - API wasn't returning CORS headers for frontend at `your-nas-ip:3000`
...
- Document SSH connection: `ssh synology` (alias for your-nas-ip:your-ssh-port, user your-ssh-user)
