...
import { useUpdateWatchlist } from '@/lib/hooks/useWatchlist';
...
export function EditWatchlistModal({
  ...
  const [isDefault, setIsDefault] = useState(watchlist.is_default);
  ...
  return (
    <Modal onClose={onClose} title="Edit Watchlist">
